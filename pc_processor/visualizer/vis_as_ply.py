...
def save_ply(pcd, label=None, file_name='pcd', dir=None):
    ...
    if dir is None:
        save_file = "/mnt/cephfs/home/lirong/code/poincloudProcessor-P2PContrast/plot_results/{}.ply".format(file_name)
    else:
...
if __name__ == '__main__':
    ...
    for frame in ('pred_21_21',	'pred_15_15',	'pred_173_173'):
        ...
        label_file = salsa_file.replace('pred_', 'label_')#.replace('salsanext0.1', 'salsanext0.01')
        points_file = salsa_file.replace('pred_', 'pcd_')#.replace('salsanext0.1', 'salsanext0.01')
