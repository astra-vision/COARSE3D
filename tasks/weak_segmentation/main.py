...
class Experiment(object):
    ...
    def _initModel(self):
        if self.settings.net_type == "SalsaNextProto":
            model = pc_processor.models.SalsaNextProto(in_channel=self.settings.input_channels,
            ...
            if self.settings.net_type == 'SqueezeSegV3Proto21':
                ...
                raise ValueError
            model = pc_processor.models.SqueezeSegV3Proto(nclasses=self.settings.n_classes,
                                                          sub_proto_size=self.settings.sub_proto_size,
                                                          ignore_label=self.settings.ignore_cls,
                                                          proto_mom=self.settings.proto_momentum,
                                                          dataset=self.settings.dataset,
            ...
            if self.settings.net_type == 'RangeNetProto21':
                ...
                raise ValueError
            model = pc_processor.models.RangeNetProto(nclasses=self.settings.n_classes,
                                                      sub_proto_size=self.settings.sub_proto_size,
                                                      ignore_label=self.settings.ignore_cls,
                                                      proto_mom=self.settings.proto_momentum,
                                                      dataset=self.settings.dataset,
